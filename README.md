...
### I. Khám phá & Tiền xử lý dữ liệu (Data Preprocessing & EDA)
...
2.  **Trực quan hóa (Exploratory Data Analysis - EDA):**
...
### III. Xây dựng & Đánh giá Mô hình (Modeling)
